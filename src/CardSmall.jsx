...
export default function CardSmall({ card, shownCards, select, selectedCards }) {
  ...
  return (
    ...
    <div className={`text-sm md:text-base font-normal h-12 w-8 md:h-8 md:w-12 rounded-none justify-center ${isShown ? 'bg-gray-400' : isSelected ? 'bg-green-200': 'bg-white'}  border-2 border-slate-500 cursor-pointer flex items-center shadow-md relative`}>
